{include file=poste_head.tpl titre_page="Atlas oiseaux nicheurs R. Responsable"}
...
function ouvre_carre(c) {
    J('#dlg-carre').dialog({width:300, height:200, title: c});
    J('#dlg-carre').html('<a style="color:blue;" target=_blank href="?t=atlas_oiseaux_nicheurs_r_carre&nom='+c+'">Cliquez ici pour voir le détail des résultats</a>');
}
...
{foreach from=$resultats item=r}
	{assign var=n value=0}
	ajout('{$r.wkt}','{$r.nom}',{$r.n});
{/foreach}
